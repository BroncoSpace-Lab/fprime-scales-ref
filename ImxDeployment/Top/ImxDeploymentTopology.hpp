// ======================================================================
// \title  ImxDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef IMXDEPLOYMENT_IMXDEPLOYMENTTOPOLOGY_HPP
#define IMXDEPLOYMENT_IMXDEPLOYMENTTOPOLOGY_HPP
// Included for access to ImxDeployment::TopologyState and ImxDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <ImxDeployment/Top/ImxDeploymentTopologyDefs.hpp>

// Remove unnecessary ImxDeployment:: qualifications
 ...
 * ImxDeployment::TopologyState see: ImxDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type ImxDeployment::TopologyState see: ImxDeploymentTopologyDefs.hpp.
 *
