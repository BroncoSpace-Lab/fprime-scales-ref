module ImxDeployment {
  ...
  instance inaManager: scalesSvc.InaManager base id 0x4A00 \
    queue size 10 \
    stack size 8192 \
    priority 100
  ...
  instance imx_gpioJetsonEnable: Drv.LinuxGpioDriver base id 0x105000

  instance inaI2CDriver: Drv.LinuxI2cDriver base id 0x105100
}