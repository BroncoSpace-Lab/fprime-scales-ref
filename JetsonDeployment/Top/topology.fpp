module JetsonDeployment {
  ...
  topology JetsonDeployment {
    ...
    connections Downlink {
      ...
      jetson_eventLogger.PktSend -> jetson_hubComQueue.comQueueIn[0]
      jetson_tlmSend.PktSend -> jetson_hubComQueue.comQueueIn[1]
      jetson_fileDownlink.bufferSendOut -> jetson_hubComQueue.buffQueueIn[0]

      jetson_hubComQueue.comQueueSend -> jetson_hubFramer.comIn
      jetson_hubComQueue.buffQueueSend -> jetson_hubFramer.bufferIn

      jetson_hubFramer.framedAllocate -> jetson_bufferManager.bufferGetCallee
      jetson_hubFramer.framedOut -> jetson_hubComStub.comDataIn
      ...
      jetson_hubComStub.comStatus -> jetson_hubFramer.comStatusIn
      jetson_hubFramer.comStatusOut -> jetson_hubComQueue.comStatusIn
      jetson_hubComStub.drvDataOut -> jetson_hubComDriver.$send
