...
# add Resnet to build dir
find ./Components/ -type f -name "*resnet*.py" | xargs cp -t $PYTHON_BUILD

# add yolo to build dir
find ./Components/ -type f -name "*yolo*.py" | xargs cp -t $PYTHON_BUILD
find ./Components/ -type f -name "depthanything.py" | xargs cp -t $PYTHON_BUILD
